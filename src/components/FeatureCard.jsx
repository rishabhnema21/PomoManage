...
const FeatureCard = ({data, reference}) => {
  ...
  return (
    <div className='feature-card w-full sm:hover:scale-105 transition ease duration-200 rounded-2xl shadow-md bg-gradient-to-br from-[#101021] to-[#121244] md:w-auto text-center'>
